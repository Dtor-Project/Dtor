...
# Create dtor user
RUN adduser --system --group --disabled-password dtor && \
	mkdir -p /wallet /home/dtor/.dtor && \
	chown -R dtor:dtor /home/dtor/.dtor && \
	chown -R dtor:dtor /wallet

# Contains the blockchain
VOLUME /home/dtor/.dtor
...
ENTRYPOINT ["dtord", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=34567", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=34568", "--non-interactive", "--confirm-external-bind"]
